...
const SUPPORT_FLOW_LOCALES: Record<UserLocale, SupportFlowLocaleStrings> = {
  en: {
    ...
    stepMessages: {
      login: "Try these first:\n1. Use the same login method you used when you signed up.\n2. If you use email login, try password reset from the dashboard.\n3. If Google signup and email signup used the same email, use the original method.",
      passcode: "Try these first:\n1. Ask the channel owner whether the passcode changed.\n2. Re-enter the channel from the latest shared link.\n3. If you were inside before but got locked out, refresh once so the latest gate state loads.",
      blocked: "If you see a blocked or frozen state:\n1. Check whether the owner left a block reason or notice.\n2. If the room allows a one-time appeal, send it from the chat input.\n3. If the whole channel is frozen, only the owner or platform team can review that state.",
      reports: "For safety or report questions:\n1. Message-level reports are available from the message menu.\n2. Channel-level reports are available from the header menu.\n3. If you already reported something, include when you sent it and what you expected to happen.",
      live: "For live-session issues:\n1. Live chat is separate from regular chat.\n2. Live messages disappear when the live session ends.\n3. If reactions or emoji effects look stale, reconnect once and try again.",
    },
  ...
  ko: {
    ...
    startMessage: "안녕하세요. 어떤 도움이 필요하신가요?",
    stepMessages: {
      login: "먼저 이것부터 확인해 주세요.\n1. 가입할 때 사용한 로그인 방식과 같은 방식으로 로그인해 보세요.\n2. 이메일 로그인이라면 대시보드에서 비밀번호 재설정을 시도해 보세요.\n3. 같은 이메일로 구글 가입과 이메일 가입을 혼용했다면 처음 사용한 방식으로 로그인해야 할 수 있어요.",
      passcode: "먼저 이것부터 확인해 주세요.\n1. 방장에게 비밀번호가 바뀌었는지 확인해 보세요.\n2. 가장 최근에 공유된 링크로 다시 입장해 보세요.\n3. 원래 들어와 있었는데 막혔다면 새로고침 한 번으로 최신 잠금 상태를 불러와 보세요.",
      blocked: "차단 또는 동결 상태라면 이렇게 확인해 주세요.\n1. 차단 사유나 공지 메시지가 남아 있는지 확인해 보세요.\n2. 방에서 1회 이의 제기를 허용한다면 채팅 입력창에서 이의 제기를 보내세요.\n3. 채널 전체가 동결된 경우에는 방장이나 운영팀만 상태를 검토할 수 있어요.",
      reports: "신고나 안전 관련 문의라면 이렇게 확인해 주세요.\n1. 메시지 신고는 메시지 메뉴에서 할 수 있어요.\n2. 채널 신고는 헤더 메뉴에서 할 수 있어요.\n3. 이미 신고했다면 언제 신고했고 어떤 조치를 기대했는지 같이 알려주시면 좋아요.",
      live: "라이브 세션 문제라면 이렇게 확인해 주세요.\n1. 라이브 채팅은 일반 채팅과 별도예요.\n2. 라이브 메시지는 세션이 종료되면 사라져요.\n3. 반응이나 이모지 효과가 이상하면 한 번 다시 연결한 뒤 시도해 보세요.",
    },
