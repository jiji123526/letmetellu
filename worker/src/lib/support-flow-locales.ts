...
const SUPPORT_FLOW_LOCALES: Record<UserLocale, SupportFlowLocaleStrings> = {
  en: {
    ...
    stepMessages: {
      ...
      billing: "For purchase or billing issues: 1. Check the product name and purchase time. 2. Confirm which account email you used. 3. If something is missing, support will usually need those details before they can help.",
    },
  ...
  ko: {
    ...
    stepMessages: {
      ...
      billing: "결제나 구매 문제라면 이렇게 확인해 주세요. 1. 구매한 상품 이름과 결제 시간을 확인해 주세요. 2. 어떤 계정 이메일로 결제했는지 확인해 주세요. 3. 누락 문제가 있다면 운영팀이 이 정보부터 필요로 할 가능성이 높아요.",
    },
