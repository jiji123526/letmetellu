...
function corsHeaders(origin: string, allowedOrigin: string): HeadersInit {
  ...
  return {
    ...
    "Access-Control-Allow-Headers": "Content-Type, Authorization, X-Internal-Token, X-User-Id, X-Authenticated-User-Id, X-Room-Token, X-Anonymous-Token, X-Device-Token",
