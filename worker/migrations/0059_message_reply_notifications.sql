-- Keep authenticated notification ownership separate from public messages.
...
-- SQLite cannot alter the notification_outbox event_type CHECK constraint
-- in place, so rebuild it with message_reply added.
ALTER TABLE notification_outbox RENAME TO notification_outbox_legacy;

CREATE TABLE notification_outbox (
  id TEXT PRIMARY KEY,
  event_type TEXT NOT NULL CHECK (event_type IN (
    'self_test', 'channel_message', 'message_reply', 'live_start', 'dm',
