...
- Continue unified public-message/DM pagination from the completed cursor, reader,
  ...
  bootstrap/reconnect and history/navigation stages into realtime mutation
  normalization, fan-out validation, special-channel and controlled-rollout work in
