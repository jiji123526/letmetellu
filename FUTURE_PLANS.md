...
2. Complete deployed browser regression checks for support, report and cross-tab auth transitions; the corresponding lifecycle, state-reconciliation and socket-revocation boundaries are covered.
