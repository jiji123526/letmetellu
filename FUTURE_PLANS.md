...
2. Complete deployed browser regression checks for support and report transitions; guided-support invariants, authoritative ticket-dashboard refresh and report-state reconciliation are covered.
