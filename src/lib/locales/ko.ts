export const ko = {
  ...
  guestOnboardingGuideDesc: "공유받은 채널을 열면 대시보드가 다음 방문을 기억합니다.",
  ...
  guestOnboardingReturnTitle: "최근 채널에서 다시 방문",
  guestOnboardingReturnDesc: "들어갔던 채널은 이 대시보드에 저장되어 다음에 바로 돌아갈 수 있어요.",
