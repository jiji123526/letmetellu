...
export const en: Record<LocaleKeys, string> = {
  ...
  deleteAccountConfirm: "Deleting your account permanently removes every channel you own, including all messages and media. Your account history will also be erased. This cannot be undone.",
