...
export const en: Record<LocaleKeys, string> = {
  ...
  userGuideAccess: "Open this guide — You can reopen this guide anytime from the dashboard menu, and on your first visit you can also open it from the last page of the onboarding popup.",
