                    ...
                    <div key={route.route} className="flex items-center justify-between gap-3 text-[11px]">
                      ...
                      <span className="shrink-0 tabular-nums" style={{ color: "var(--meta)" }}>
                        {t("operationalHealthRouteCounts")
                          .replace("{errors}", String(route.request_5xx_count + route.preview_upstream_failure_count + route.unhandled_exception_count + route.maintenance_failure_count + route.cleanup_failure_count + route.realtime_failure_count))
