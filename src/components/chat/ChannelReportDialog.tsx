              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    padding: "11px 12px",
                    textAlign: "left",
                    border: selected ? "1px solid var(--bubble-sent, #3598fe)" : "1px solid var(--hairline, #d1d1d6)",
                    background: selected ? "color-mix(in srgb, var(--bubble-sent, #3598fe) 12%, transparent)" : "transparent",
