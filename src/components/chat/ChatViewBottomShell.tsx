      ...
      frame = requestAnimationFrame(() => {
        ...
        const baseFontSize =
          Number.parseFloat(
            ...
            ).getPropertyValue("--bubble-font-size"),
          ) || 16;
        ...
        const availableWidth = Math.max(
          1,
          window.innerWidth - 64 - actionAllowance,
        );

        const fittedSize = Math.min(
          baseFontSize,
          baseFontSize *
            (availableWidth / Math.max(1, text.scrollWidth)),
        );
  ...
  return (
    <div
      ...
      style={{
        ...
        background: banner.color.startsWith("var(")
          ? banner.color
          : `${banner.color}dd`,
...
export function ChatViewBottomShell({
  ...
  const composerFrozenForViewer =
    isFrozen && !effectiveAdmin && !dmMode;

  const plusDisabled =
    viewerInputBlocked || ownerModerationBlocked;
  ...
  const inputColor =
    ownerModerationBlocked || composerFrozenForViewer
      ? "#999"
      : "var(--gray-text)";
      ...
      {ownerModerationBlocked && (
        <div
          ...
          style={{
            ...
            borderTop:
              "0.5px solid rgba(139,92,246,.18)",
            color: "#5b21b6",
          }}
        >
          <div
