...
export function NoticeBanner({ channelId, notice, onDismiss }: NoticeBannerProps) {
  ...
  return (
    <div style={{ position: "absolute", top: "12px", left: "12px", right: "12px", zIndex: 12, pointerEvents: "none" }}>
      ...
      >
        <span style={{ width: "28px", height: "28px", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", color: "var(--notice-text)", background: "color-mix(in srgb, var(--notice-text) 8%, transparent)", borderRadius: "999px" }}>
